...
export abstract class QueryBuilderClassExplorerTreeNodeData extends QueryBuilderExplorerTreeNodeData {
...
export class QueryBuilderExplorerTreeRootNodeData extends QueryBuilderClassExplorerTreeNodeData {
  constructor(
    id: string,
    label: string,
    dndText: string,
...
export class QueryBuilderExplorerTreePropertyNodeData extends QueryBuilderClassExplorerTreeNodeData {
...
export class QueryBuilderExplorerTreeSubTypeNodeData extends QueryBuilderClassExplorerTreeNodeData {
  subclass: Class;
  parentId: string;
...
export const buildPropertyExpressionFromExplorerTreeNodeData = (
  ...
  explorerState: QueryBuilderClassExplorerState,
...
const generateExplorerTreeClassNodeChildrenIDs = (
  node: QueryBuilderClassExplorerTreeNodeData,
): string[] => {
...
export const getQueryBuilderPropertyNodeData = (
  property: AbstractProperty,
  parentNode: QueryBuilderClassExplorerTreeNodeData,
  modelCoverageAnalysisResult: MappingModelCoverageAnalysisResult,
...
const getQueryBuilderTreeData = (
  rootClass: Class,
  modelCoverageAnalysisResult: MappingModelCoverageAnalysisResult,
): TreeData<QueryBuilderClassExplorerTreeNodeData> => {
  const rootIds = [];
  const nodes = new Map<string, QueryBuilderClassExplorerTreeNodeData>();
...
export const cloneQueryBuilderExplorerTreeNodeData = (
  node: QueryBuilderClassExplorerTreeNodeData,
): QueryBuilderClassExplorerTreeNodeData => {
...
export class QueryBuilderClassExplorerState extends QueryBuilderExplorerState<QueryBuilderClassExplorerTreeNodeData> {
  ...
  override humanizePropertyName = true;
  ...
  setTreeData(
    val: TreeData<QueryBuilderClassExplorerTreeNodeData> | undefined,
  ): void {
    this.treeData = val;
  }
